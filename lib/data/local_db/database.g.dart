    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Person` (`id` INTEGER NOT NULL, `firstName` TEXT, `lastName` TEXT, `email` TEXT, `age` TEXT, `address` TEXT, `district` TEXT, `subDistrict` TEXT, `province` TEXT, `country` TEXT, `phoneNumber` TEXT, `zipCode` TEXT, PRIMARY KEY (`id`))');
